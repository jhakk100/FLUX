...
프로젝트는 사용자·superior·최대 4명의 역할별 모델이 하나의 대화방에서 순서대로 검토하는 구조입니다. superior의 API·모델, 멤버별 역할·순서·시간, 1~3회 협업 라운드와 빈 응답 자동 재시도 횟수를 프로젝트마다 설정할 수 있습니다. 사용법과 각 시간 설정의 뜻은 [프로젝트 단체방 안내](./docs/user/PROJECT_COLLABORATION.md)를 참고하세요.
